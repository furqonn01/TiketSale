            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label text-md-right"><i class="fas fa-space-shuttle"> Nama Tiket
                            </i></label>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label text-md-right"><i class="fab fa-500px"> Jenis Tiket
                            </i></label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label text-md-right"><i class="fas fa-address-book"> Nama
                                kategori </i></label>
                        <div class="col-md-6">
                            {!!
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label text-md-right"><i class="fas fa-money-bill-alt"> Harga
                            </i></label>
                        <div class="col-md-6">
